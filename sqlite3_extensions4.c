...
#include "../sqlite/ext/fts5/fts5_test_tok.c"
#include "../sqlite/ext/fts5/fts5_tokenize.c"
#include "../sqlite/ext/fts5/fts5_unicode2.c"
#include "../sqlite/ext/fts5/fts5_varint.c"
#include "../sqlite/ext/fts5/fts5_vocab.c"
