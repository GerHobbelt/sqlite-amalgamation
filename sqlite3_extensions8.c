...
#include "../sqlite/ext/recover/sqlite3recover.c"
#include "../sqlite/ext/recover/test_recover.c"

//#include "../sqlite/ext/wasm/api/sqlite3-wasm.c"
//#include "../sqlite/ext/wasm/jaccwabyt/jaccwabyt_test.c"
