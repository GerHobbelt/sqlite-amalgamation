...
/* SQLITE_PRIVATE int sqlite3PagerCommitPhaseOne(Pager*,Btree*,const char *zSuper, int); */
/* SQLITE_PRIVATE int sqlite3PagerExclusiveLock(Pager*, DbPage *pPage1, Pgno*); */
...
/* SQLITE_PRIVATE void sqlite3PagerScanFailure(Btree *pBt, Pager *pPager); */
#else
...
SQLITE_PRIVATE int sqlite3BtreeScanStart(
  BtCursor *pCsr,
  UnpackedRecord *pKey,
  i64 iKey,
  int opcode,
...
SQLITE_PRIVATE int sqlite3BtreeScanLimit(
  BtCursor *pCsr,
  UnpackedRecord *pKey,
  i64 iKey,
  int opcode
);
/* SQLITE_PRIVATE int sqlite3BtreeScanWrite(BtCursor *pCsr, int op, i64 id, const u8 *a, int n); */
typedef struct PgHdr PgHdr;
/* SQLITE_PRIVATE int sqlite3BtreeScanDirty(Btree *pBtree, Bitvec *pRead, PgHdr *pList); */
...
SQLITE_API void sqlite3VdbeSetVarmask(Vdbe*, int);
...
SQLITE_API void sqlite3ExprAssignVarNumber(Parse*, Expr*, u32);
...
/* SQLITE_PRIVATE int sqlite3BitvecArray(Bitvec*, u32 **pa, int *pn); */
#ifndef SQLITE_UNTESTABLE
...
/* SQLITE_PRIVATE int sqlite3RunVacuum(char**, sqlite3*, int, sqlite3_value*, int); */
...
** file.
*/
SQLITE_API int sqlite3PutVarint(unsigned char*, u64);
SQLITE_API int sqlite3GetVarint(const unsigned char *, u64 *);
SQLITE_API int sqlite3GetVarint32(const unsigned char *, u32 *);
SQLITE_API int sqlite3VarintLen(u64 v);
...
SQLITE_API extern SQLITE_WSD struct Sqlite3Config sqlite3Config;
...
/* SQLITE_PRIVATE void sqlite3BtreeScanDerefList(CursorScan*); */
